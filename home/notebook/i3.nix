...
#feh --bg-scale --zoom fill ~/repos/anime/dead_eyes.jpg This file has been auto-generated by i3-config-wizard(1).
...
# exec --no-startup-id feh --randomize --bg-fill ~/Images/wallpapers/*
set $mod Mod4

exec_always --no-startup-id feh --bg-fill  ~/.dotfiles/wallpaper/forest-foggy-misty-cloudy.png
...
## Screenshots
#bindsym Print exec --no-startup-id maim "/home/$USER/Images/$(date)"
#bindsym $mod+Print exec --no-startup-id maim --window $(xdotool getactivewindow) "/home/$USER/Imagens/$(date)"
#bindsym Shift+Print exec --no-startup-id maim --select "/home/$USER/Imagens/$(date)"
